...
import 'package:ticketerqrscan/model/VendorListModel.dart';
import 'package:ticketerqrscan/service/auth_repo.dart';
...
class HomepageController extends GetxController {
  ...
  void getCheckGuestList() async {
    guestList.clear();
    service
        .apiGetGuestList(PreferenceUtils.getString("eventId"),
  ...
  void deleteAccount() async {
    ...
    AuthService().apiDeleteAccount().then((value) {
