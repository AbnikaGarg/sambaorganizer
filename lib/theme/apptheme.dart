...
class AppTheme {
  ...
  static Color primaryColor = const Color.fromRGBO(
      153, 68, 230, 1); //const Color.fromRGBO(59, 211, 169, 1);
  static Color lightprimaryColor = Color.fromARGB(255, 214, 174, 251); // Color(0xFF31D7A9).withOpacity(0.15);//Color(0xFF31D7A9).withOpacity(0.15);
